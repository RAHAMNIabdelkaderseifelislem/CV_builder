                            ...
                            <div class="col-md-3 text-center col-md-12">
                                <div class="profile">
                                    ...
                                    <div class="profile-information">
                                        <ul>
                                            <li>Name : <span class="info" id="names"> RAHMANI
                                                    Abd El Kader Seif El Islem</span></li>


                                            <li>BirthDay : <span class="info" id="dobs">
                                                    16-November-2002</span></li>


                                            <li>Job : <span class="info" id="jobs"> Frelancer</span></li>
                                            <li>Email : <span class="info" id="emails">
                                                    a.e.k426rahmani@gmail.com</span></li>
                                        </ul>
                                    </div>
                            ...
                            <div class="col-md-8 col-md-12 cv-content mt-5">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-12">
                                            <div class="contact">
                                                ...
                                                <ul>
                                                    <li>Mobile : <span class="info" id="contacts">+213 668 704 202</span></li>
                                            ...
                                            <div class="lang">
                                                ...
                                                <ul>
                                                    <li id="langs">English,Arabic,French</li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="cv-skill">
                                    <div class="row">
                                        ...
                                        progress-bar-animated" id="xds" role="progressbar" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100" style="width: 35%"></div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-md-6 col-sm-12">
                                            <div class="coding-skill mt-4">
                                                ...
                                                <div class="progress">
                                                    <div class="progress-bar
                                        progress-bar-striped
                                        progress-bar-animated bg-info" id="jss" role="progressbar" aria-valuenow="68" aria-valuemin="0" aria-valuemax="100" style="width: 75%"></div>
                                        <h4>Python</h4>

                                                <div class="progress">
                                                    <div class="progress-bar
                                        progress-bar-striped
                                        progress-bar-animated bg-info" id="jss" role="progressbar" aria-valuenow="65" aria-valuemin="0" aria-valuemax="100" style="width: 75%"></div>
                                                <h4>Javascirpt</h4>

                                                <div class="progress">
                                                    <div class="progress-bar
                                        progress-bar-striped
                                        progress-bar-animated bg-info" id="jss" role="progressbar" aria-valuenow="35" aria-valuemin="0" aria-valuemax="100" style="width: 75%"></div>
                                                </div>
                                                <h4 class="mt-5">php</h4>
                                        ...
                                        bg-success" role="progressbar" id="lvs" aria-valuenow="45" aria-valuemin="0" aria-valuemax="100" style="width: 65%"></div>
                                                ...
                                                <div class="progress">
                                                    <div class="progress-bar
                                        progress-bar-striped
                                        progress-bar-animated" id="res" role="progressbar" aria-valuenow="57" aria-valuemin="0" aria-valuemax="100" style="width: 35%"></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
